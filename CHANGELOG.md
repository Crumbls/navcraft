...
### Changed
- Dependabot's cooldown now has an explicit 7-day default for Composer dependencies without a SemVer-specific rule.

## [0.2.1] - 2026-08-19

### Changed
- Dependabot waits 30 days for major, 7 days for minor, and 3 days for patch dependency releases before opening version-update pull requests.
